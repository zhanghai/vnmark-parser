...
export type StartRuleNames = "Document" | "Line";
...
declare function ParseFunction<Options extends ParseOptions<"Document">>(
  input: string,
  options?: Options,
): import('./vnmark.d.ts').Document;

declare function ParseFunction<Options extends ParseOptions<"Line">>(
  input: string,
  options?: Options,
): import('./vnmark.d.ts').Line;

declare function ParseFunction<Options extends ParseOptions<StartRuleNames>>(
  input: string,
  options?: Options,
): import('./vnmark.d.ts').Document | import('./vnmark.d.ts').Line;
